		...
		<footer class="text-center lg:text-left bg-gray-100 text-gray-600">
			<div className="py-6 px-4 sm:p-6 md:py-10 md:px-8">
				<div className="container max-w-4xl lg:max-w-5xl mx-auto">
					<div class="py-10 text-center md:text-left border-t border-gray-300">
						<div class="grid grid-cols-2 md:grid-cols-4 gap-8">
							<div class="">
								<h6 class="uppercase font-semibold mb-4 flex items-center justify-center md:justify-start">
									...
									Objednávky apartmánů
								</h6>
								<p>Apartmány lze rezervovat prostřednictvím webové aplikace nebo telefonicky.</p>
							</div>
							<div class="">
								<h6 class="uppercase font-semibold mb-4 flex justify-center md:justify-start">Užitečné odkazy</h6>
								<p class="mb-4">
							...
							<div class="">
								<h6 class="uppercase font-semibold mb-4 flex justify-center md:justify-start">Kontakt</h6>
